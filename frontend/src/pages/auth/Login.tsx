...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    // Structure prepared for Google Login redirection
      ...
      <div className="relative z-10 w-full max-w-[480px] p-4">
        <div className="flex flex-col items-center rounded-2xl border border-border bg-card p-8 text-center shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] md:p-10">
          ...
          <button
            ...
            type="button"
            className="group flex h-12 w-full items-center justify-center gap-3 rounded-lg border border-border bg-background px-6 text-[15px] font-medium text-foreground shadow-sm transition-all duration-200 hover:bg-muted hover:shadow-md"
          >
          ...
          {/* Footer Links inside Card (High Trust) */}
